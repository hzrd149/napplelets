// napplets/dsui-gm-proto/src/lib/nap-capabilities.ts
//
// Runtime NAP capability probe for the GM inbox.
//
// dsui-gm-proto doubles as a runtime/shell debugging napplet: when the host
...
export interface NapRequirement {
  ...
  label: string;
  /** What dsui-gm-proto uses the NAP for. */
  purpose: string;
...
/**
 * The NAPs dsui-gm-proto reports, in display order. Every entry belongs in
...
/**
 * Probe the live runtime for the NAPs dsui-gm-proto needs. Domain presence is
